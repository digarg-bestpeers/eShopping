...
class MyPasswordChangeForm(PasswordChangeForm):
  ...
  new_password2 = forms.CharField(label=_("Confrm New Password"), strip=False, widget=forms.PasswordInput(attrs={'autocomplete': 'new-password', 'autofocus':True, 'class':'form-control'}))
